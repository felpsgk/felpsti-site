                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            ...
                            <h1 class="display-3 fw-bolder mb-5"><span class="text-gradiente d-inline">Entre em contato já!</span></h1>
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-xxl-8">
                        <div class="text-center my-5">
                            <h2 class="display-5 fw-bolder"><span class="text-gradiente d-inline">Sobre mim ,</span></h2>
                            <p class="lead fw-light mb-4">Mano felps!</p>
                            <p class="text-muted">Eu sou mano felps!</p>
                            <div class="d-flex justify-content-center fs-2 gap-4">
                                <a class="text-gradiente" href="#!"><i class="bi bi-twitter"></i></a>
                                <a class="text-gradiente" href="#!"><i class="bi bi-linkedin"></i></a>
                                <a class="text-gradiente" href="#!"><i class="bi bi-github"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
